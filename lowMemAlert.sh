...
# 6. Reboot the laptop
# 7. Log in and simulate low memory scenario by running high memory consuming processes until free memory space reaches desired low free memory space in megabytes
