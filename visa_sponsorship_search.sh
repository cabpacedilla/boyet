#!/usr/bin/env bash
# ============================================================
# Himalayas Job Search - Senior QA/SDET Roles
...
cleanup() {
    # Kill all child processes (subshells, jq, etc.)
    pkill -P $$ 2>/dev/null
    # Release the lock
...
visa_send_email() {
    ...
    local subject="🎯 Visa Sponsorships Job Alert: $total_count new Senior QA/SDET positions"
